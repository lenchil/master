...
python3 aws-iot-device-sdk-python-v2/samples/test.py --endpoint a117fwqfuse8es-ats.iot.eu-north-1.amazonaws.com --ca_file root-CA.crt --cert test_vm.cert.pem --key test_vm.private.key --client_id message_topic --topic message_topic  --count 0 --message test#!/usr/bin/env bash
# stop script on error
set -e
